...
public class SampleActivity extends BaseActivity implements UCropFragmentCallback {
    ...
    if (resultCode == RESULT_OK) {
      if (requestCode == requestMode) {
        ...
        if (selectedUri != null) {
          ...
          Toast.makeText(SampleActivity.this, R.string.toast_cannot_retrieve_selected_image,
      ...
      if (s != null && !s.toString().trim().isEmpty()) {
        if (Integer.valueOf(s.toString()) < UCrop.MIN_SIZE) {
          Toast.makeText(SampleActivity.this,
              String.format(getString(R.string.format_max_cropped_image_size), UCrop.MIN_SIZE),
              Toast.LENGTH_SHORT).show();
        }
      }
    }
  ...
  private void setupUI() {
    ...
    mTextViewQuality.setText(
        String.format(getString(R.string.format_quality_d), mSeekBarQuality.getProgress()));
...
//    } else {                                                        // else start uCrop Activity
      ...
      options.setToolbarWidgetColor(Color.BLUE);
...
//    }
  ...
  /**
   * Sometimes you want to adjust more options, it's done via {@link com.yalantis.ucrop.UCrop.Options}
   * class.
   *
   * @param uCrop - ucrop builder instance
   * @return - ucrop builder instance
  ...
  private void handleCropResult(@NonNull Intent result) {
    ...
    if (resultUri != null) {
      ...
      Toast.makeText(SampleActivity.this, R.string.toast_cannot_retrieve_cropped_image,
          Toast.LENGTH_SHORT).show();
    }
  }
  ...
  private void handleCropError(@NonNull Intent result) {
    ...
    if (cropError != null) {
      ...
      Toast.makeText(SampleActivity.this, R.string.toast_unexpected_error, Toast.LENGTH_SHORT)
          .show();
    }
  }
  ...
  public void setupViews(Bundle args) {
    ...
    mToolbarCancelDrawable = args
        .getInt(UCrop.Options.EXTRA_UCROP_WIDGET_CANCEL_DRAWABLE, R.drawable.ucrop_ic_cross);
    mToolbarCropDrawable = args
        .getInt(UCrop.Options.EXTRA_UCROP_WIDGET_CROP_DRAWABLE, R.drawable.ucrop_ic_done);
  ...
  private void setupAppBar() {
    ...
    Drawable stateButtonDrawable = ContextCompat
        .getDrawable(getBaseContext(), mToolbarCancelDrawable);
  ...
  public boolean onCreateOptionsMenu(final Menu menu) {
    ...
    Drawable menuItemCropIcon = ContextCompat.getDrawable(this,
        mToolbarCropDrawable == 0 ? R.drawable.ucrop_ic_done : mToolbarCropDrawable);
